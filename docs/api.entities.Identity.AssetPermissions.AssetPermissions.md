...
| `opts` | `Object` | - |
| `opts.asset` | `string` \| [`Asset`](../wiki/api.entities.Asset.Asset) | - |
| `opts.eventId?` | [`PublicEnum8F5A39C8Ee`](../wiki/types.PublicEnum8F5A39C8Ee) | filters results by event |
| `opts.moduleId?` | [`PublicEnum7A0B4Cc03E`](../wiki/types.PublicEnum7A0B4Cc03E) | filters results by module |
| `opts.size?` | `BigNumber` | page size |
| `opts.start?` | `BigNumber` | page offset |
