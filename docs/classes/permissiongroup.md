...
* [toHuman](permissiongroup.md#abstract-tohuman)
...
*Defined in [src/api/entities/PermissionGroup.ts:35](https://github.com/PolymathNetwork/polymesh-sdk/blob/31a16a34/src/api/entities/PermissionGroup.ts#L35)*
...
*Inherited from [Entity](entity.md).[toHuman](entity.md#abstract-tohuman)*
